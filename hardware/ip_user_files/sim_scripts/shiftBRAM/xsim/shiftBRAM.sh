...
#
# Script generated by Vivado on Tue Feb 25 10:15:32 IST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : shiftBRAM.sh
...
#
# Usage        : shiftBRAM.sh
#                shiftBRAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                shiftBRAM.sh [-reset_run]
#                shiftBRAM.sh [-reset_log]
#                shiftBRAM.sh [-help]
#
...
# script info
echo -e "shiftBRAM.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./shiftBRAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot shiftBRAM xil_defaultlib.shiftBRAM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim shiftBRAM -key {Behavioral:sim_1:Functional:shiftBRAM} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb shiftBRAM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./shiftBRAM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: shiftBRAM.sh [-help]\n\
Usage: shiftBRAM.sh [-step]\n\
Usage: shiftBRAM.sh [-lib_map_path]\n\
Usage: shiftBRAM.sh [-reset_run]\n\
Usage: shiftBRAM.sh [-reset_log]\n\
Usage: shiftBRAM.sh [-keep_index]\n\
Usage: shiftBRAM.sh [-noclean_files]\n\n\
