...
module core #(parameter CORE_ID = 7'b0)
    ...
    programBlock16 coreProgMem (
        .clka(clk),          
        .ena(~prog_wena),        // Read enable --> whenever it is not being written to
    ...
    DualPortBlock16 sb0 (
        ...
        .ena(1'b0),          // Shift operation doesn't require read enable
    ...
    wire rsta_busy0, rsta_busy1, rstb_busy0, rstb_busy1;
    dualPortBlock18 fb0 (
        .clka(clk),          
        .rsta(rst),          
        .ena(~fb_wen0),      
