...
#
# Script generated by Vivado on Sun Mar 09 14:09:50 IST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : programBlock16.sh
...
#
# Usage        : programBlock16.sh
#                programBlock16.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                programBlock16.sh [-reset_run]
#                programBlock16.sh [-reset_log]
#                programBlock16.sh [-help]
#
...
#                script (type 'programBlock16.sh -help' for more information).
#
...
# script info
echo -e "programBlock16.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./programBlock16.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.programBlock16 xil_defaultlib.glbl -o programBlock16_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./programBlock16_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key programBlock16_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc programBlock16_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./programBlock16.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: programBlock16.sh [-help]\n\
Usage: programBlock16.sh [-step]\n\
Usage: programBlock16.sh [-lib_map_path]\n\
Usage: programBlock16.sh [-reset_run]\n\
Usage: programBlock16.sh [-reset_log]\n\
Usage: programBlock16.sh [-keep_index]\n\
Usage: programBlock16.sh [-noclean_files]\n\n\
