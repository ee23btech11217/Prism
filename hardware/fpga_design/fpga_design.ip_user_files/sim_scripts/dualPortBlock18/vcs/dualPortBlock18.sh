...
#
# Script generated by Vivado on Wed Mar 05 14:23:58 IST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dualPortBlock18.sh
...
#
# Usage        : dualPortBlock18.sh
#                dualPortBlock18.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dualPortBlock18.sh [-reset_run]
#                dualPortBlock18.sh [-reset_log]
#                dualPortBlock18.sh [-help]
#
...
#                script (type 'dualPortBlock18.sh -help' for more information).
#
...
# script info
echo -e "dualPortBlock18.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dualPortBlock18.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dualPortBlock18 xil_defaultlib.glbl -o dualPortBlock18_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dualPortBlock18_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dualPortBlock18_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dualPortBlock18_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dualPortBlock18.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dualPortBlock18.sh [-help]\n\
Usage: dualPortBlock18.sh [-step]\n\
Usage: dualPortBlock18.sh [-lib_map_path]\n\
Usage: dualPortBlock18.sh [-reset_run]\n\
Usage: dualPortBlock18.sh [-reset_log]\n\
Usage: dualPortBlock18.sh [-keep_index]\n\
Usage: dualPortBlock18.sh [-noclean_files]\n\n\
