...
#
# Script generated by Vivado on Sun Mar 02 11:04:16 IST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dualPortBlockAXI18.sh
...
#
# Usage        : dualPortBlockAXI18.sh
#                dualPortBlockAXI18.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dualPortBlockAXI18.sh [-reset_run]
#                dualPortBlockAXI18.sh [-reset_log]
#                dualPortBlockAXI18.sh [-help]
#
...
#                script (type 'dualPortBlockAXI18.sh -help' for more information).
#
...
# script info
echo -e "dualPortBlockAXI18.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dualPortBlockAXI18.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dualPortBlockAXI18 xil_defaultlib.glbl -o dualPortBlockAXI18_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dualPortBlockAXI18_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mihir/Prism/hardware/fpga_design/fpga_design.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key dualPortBlockAXI18_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dualPortBlockAXI18_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dualPortBlockAXI18.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dualPortBlockAXI18.sh [-help]\n\
Usage: dualPortBlockAXI18.sh [-step]\n\
Usage: dualPortBlockAXI18.sh [-lib_map_path]\n\
Usage: dualPortBlockAXI18.sh [-reset_run]\n\
Usage: dualPortBlockAXI18.sh [-reset_log]\n\
Usage: dualPortBlockAXI18.sh [-keep_index]\n\
Usage: dualPortBlockAXI18.sh [-noclean_files]\n\n\
