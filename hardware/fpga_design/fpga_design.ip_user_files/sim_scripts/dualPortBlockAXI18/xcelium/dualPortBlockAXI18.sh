...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dualPortBlockAXI18 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dualPortBlockAXI18 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mihir/Prism/hardware/fpga_design/fpga_design.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dualPortBlockAXI18_sc.so .tmp_log xcelium_lib waves.shm c.obj)
