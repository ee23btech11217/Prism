...
//638667/1489886/2.50/3/2/Transistor BJT NPN
...
(library Library_1
	...
	(symbolDef "PMBT3904_215" (originalName "PMBT3904_215")
	...
	(compDef "PMBT3904,215" (originalName "PMBT3904,215") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "PMBT3904_215"))
		...
		(attr "Mouser Part Number" "771-PMBT3904-T/R")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Nexperia/PMBT3904215?qs=LOCUfHb8d9tXximHEgx1nw%3D%3D")
		(attr "Manufacturer_Name" "Nexperia")
		(attr "Manufacturer_Part_Number" "PMBT3904,215")
		(attr "Description" "PMBT3904 - 40 V, 200 mA NPN switching transistor@en-us")
		(attr "<Hyperlink>" "https://assets.nexperia.com/documents/data-sheet/PMBT3904.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "PMBT3904,215.stp")
