...
(library Library_1
	...
	(compDef "NC7WZ07P6X" (originalName "NC7WZ07P6X") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "6" (pinName "Y1") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "VCC") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "Y2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.onsemi.com/pub/Collateral/NC7WZ07-D.PDF")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "NC7WZ07P6X.stp")
